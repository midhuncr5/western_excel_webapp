...
# # ---------------------------------------------------
# # SAVE (NO DATA LOSS ON RERUN)
# # ---------------------------------------------------
# if submit:
#     try:
#         # Persist edited data before rerun
#         st.session_state.edited_df = edited_df.copy()

#         # Update main df using index
#         df.loc[df_ui.index, ["APPROVAL_1", "APPROVAL_2"]] = \
#             edited_df[["APPROVAL_1", "APPROVAL_2"]].values

#         st.session_state.df = df.copy()

#         # Upload to Excel immediately
#         upload_excel(FILE_ID, df)

#         # Clear cache so fresh data loads next time
#         st.cache_data.clear()

#         st.success("✅ Changes saved and reflected instantly!")
...
# ---------------------------------------------------
# LOAD DATA (NO UNWANTED RERUN EFFECT)
# ---------------------------------------------------
